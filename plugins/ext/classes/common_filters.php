...
class common_filters
{
    ...
    function render($title)
    {
        ...
        $reports_query = db_query("select id, name, dashboard_counter_hide_count from app_reports where entities_id='" . $this->entities_id . "' and reports_type='common_filters' and in_dashboard_counter=0 and (length(users_groups)=0 or find_in_set(" . $app_user['group_id'] . ",users_groups)) order by dashboard_sort_order");

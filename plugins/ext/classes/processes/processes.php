...
class processes
{
    ...
    {
        $check_qeury = db_query("select id from app_ext_processes_actions where process_id='" . $process_id . "' and locate('insert_item_entity_',type)>0");
                ...
                foreach($selected_items as $item_id)
                {
                    ...
                    switch(true)
                    {
                        ...
                        case strstr($actions['type'], 'delete_item_entity_'):
                            ...
                            $items_to_delete = items::get_items_to_delete($action_entity_id, [$action_entity_id => [0 => $item_id]]);
    ...
    public static function output_action_field_value($actions_fields)
    {
        ...
        if(in_array($actions_fields['field_type'], array('fieldtype_users_approve','fieldtype_users', 'fieldtype_users_ajax', 'fieldtype_created_by', 'fieldtype_dropdown', 'fieldtype_entity', 'fieldtype_entity_ajax', 'fieldtype_entity_multilevel')))
        {

...
<script type="text/javascript" src="js/fullcalendar-scheduler/6.1.5/dist/index.global.min.js"></script>
<?php 
if(is_file($language_file_path = 'js/fullcalendar-scheduler/6.1.5/packages/core/locales/' . APP_LANGUAGE_SHORT_CODE . '.global.js')) 
